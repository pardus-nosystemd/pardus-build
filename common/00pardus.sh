...
deb http://depo.pardus.org.tr/pardus yirmibes main contrib non-free
deb http://depo.pardus.org.tr/pardus yirmibes-deb main contrib non-free
deb http://depo.pardus.org.tr/guvenlik yirmibes-deb main contrib non-free
EOF
